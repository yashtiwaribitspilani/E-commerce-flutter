...
import 'schema/saved_product_record.dart';
...
export 'schema/saved_product_record.dart';
...
/// Functions to query SavedProductRecords (as a Stream and as a Future).
Future<int> querySavedProductRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      SavedProductRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<SavedProductRecord>> querySavedProductRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      SavedProductRecord.collection,
      SavedProductRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<SavedProductRecord>> querySavedProductRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
